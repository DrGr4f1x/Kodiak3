...
//--------------------------------------------------------------------------------------
static HRESULT CreateD3DResources(ID3D12Device* d3dDevice,
	uint32_t resDim,
	size_t width,
	size_t height,
	size_t depth,
...
//--------------------------------------------------------------------------------------
static HRESULT CreateTextureFromDDS(ID3D12Device* d3dDevice,
...
HRESULT Kodiak::CreateDDSTextureFromMemory(
...
HRESULT Kodiak::CreateDDSTextureFromFile(
	ID3D12Device* d3dDevice,
	const char* fileName,
	size_t maxsize,
	bool forceSRGB,
